...
import { usePostHogFeatureFlag, FEATURE_FLAGS, captureEvent } from "@/lib/posthog";
...
export function Chat() {
  ...
  // Check if the reasoning mode feature flag is enabled
  const reasoningModeEnabled = usePostHogFeatureFlag(FEATURE_FLAGS.REASONING_MODE, false);
  // Check if the multimodal support feature flag is enabled
  const multimodalEnabled = usePostHogFeatureFlag(FEATURE_FLAGS.MULTIMODAL_INPUT, true);
  ...
  const handleSendMessage = () => {
    ...
    if (isGeneratingResponse) {
      ...
      captureEvent('message_sent', { 
        ...
        reasoning_enabled: reasoningModeEnabled ? isReasoningEnabled : false,
            ...
            <div className="absolute bottom-2.5 left-2.5">
              <div
                ...
                onClick={() => {
                  ...
                  captureEvent('reasoning_toggled', { enabled: !isReasoningEnabled });
                }}
              >
          ...
          <div className="absolute bottom-2.5 right-2.5 flex flex-row gap-2">
            ...
            <ModelSelector 
              ...
              setSelectedModelId={(modelId) => {
                setSelectedModelId(modelId);
                captureEvent('model_selected', { model: modelId });
              }}
            />
